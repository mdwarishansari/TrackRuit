  ...
  const features = [
    {
      ...
      description:
        "Get intelligent job matching and resume analysis powered by advanced machine learning algorithms.",
      icon: ChartBarIcon,
    },
    {
      name: "🚀 Auto Job Tracking",
      description:
        "Automatically track applications from LinkedIn, Internshala, and other job portals with our browser extension.",
      icon: RocketLaunchIcon,
    },
    {
      name: "📊 Smart Analytics",
      description:
        "Visualize your job search performance with detailed analytics and progress tracking.",
      icon: DocumentMagnifyingGlassIcon,
    },
    {
      name: "☁️ Cloud Sync",
      description:
        "Access your job applications and resumes from anywhere with secure cloud synchronization.",
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            ...
            >
              AI-powered job tracking platform that helps you organize, analyze,
              and optimize your job applications with intelligent insights.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Everything you need to manage your job applications efficiently
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
              Join thousands of job seekers who are already tracking their
              applications smarter with TrackRuit.
            </p>
            {!user && (
              <Link
                to="/register"
